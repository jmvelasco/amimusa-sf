 ...
 * Publications
 *
 * @ORM\Table(name="publications", indexes={@ORM\Index(name="fk_contributor_idx", columns={"id_contributor"}), @ORM\Index(name="fk_writting_idx", columns={"id_writting"}), @ORM\Index(name="fk_state_idx", columns={"id_state"})})
 * @ORM\Entity
 */
class Publications
{
